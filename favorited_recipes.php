...
<?php if ($_SESSION['valid'] == 1) { ?>
    <br><br><br>
    <div class="center">
        <h1 style="display: inline;">My Favorite Recipes</h1>
    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        INNER JOIN stuff.rel_users_fav_recipes rufr
        ON r.recipe_id = rufr.recipe_id
        ...
        if ($category != "0") {
            ...
            INNER JOIN stuff.rel_users_fav_recipes rufr
            ON r.recipe_id = rufr.recipe_id
            INNER JOIN stuff.rel_category_recipies rcr
            ON r.recipe_id = rcr.recipe_id
            WHERE r.user_id='$user_id' AND rcr.category_id='$category'";
        }
