...
<?php if ($_SESSION['valid'] == 1) { ?>
    <br><br><br>
    <div class="center">
        <h1 style="display: inline;">My Personal Recipes</h1>
    </div>
    <div class="float-right">
        <button class="button" onclick=window.location="create_recipe.php"><i class="fas fa-plus-circle"></i> New Recipe</button>
    </div>

    <br><br>

    <form action="my_recipes.php" method="post">
        <div class="center">
            <table align="center">
                <td>
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM stuff.recipes WHERE user_id='$user_id'";
        ...
        if ($category != "0") {
            ...
            ON r.recipe_id = rcr.recipe_id
            WHERE user_id='$user_id' AND rcr.category_id='$category'";
        }
        ...
        $sql = "SELECT * FROM stuff.recipes WHERE user_id='$user_id' ORDER BY recipe_name";
    }
    ...
    if ($total == 0) {
        ...
        <div class="container-card">
            <div class="card" onclick="toIndivRecipe(event, <?php echo $recipe_id; ?>)" >
                ...
                <a href="edit_recipe.php?recipe_id=<?php echo $recipe_id; ?>" style='float:left; color:cornflowerblue;' class="edit">Edit</a>
            </div>
        </div>
